...
from typing import List, Callable, Any, Dict, Optional, TypeVar, Union
import asyncio
import weakref
import logging
import threading
...
from fletx.core.state import (
    ...
    RxDict,
    Computed,
    Observer,  # ReactiveDependencyTracker
)
...
class ControllerEvent:
    ...
    def __init__(self, type: str, data: Any = None, source: Any = None):
        self.type = type
        self.data = data
        self.source = source
...
class EventBus:
    ...
    def emit(self, event: Union[str, ControllerEvent], data: Any = None):
...
class ControllerContext:
    ...
    def get_reactive(self, key: str, default: Any = None) -> Computed[Any]:
...
class FletXController:
    ...
    def _check_not_disposed(self):
        ...
        if self.is_disposed:
            raise RuntimeError(f"Controller {self.__class__.__name__} is disposed")
    ...
    def dispose(self):
        ...
        # Remove from DI container to prevent memory leaks
        DI.delete(FletXController, f"controller_{self._id}")
        DI.delete(EffectManager, f"effects_{self._id}")
    ...
    def use_effect(
        self, effect_fn: Callable, deps: List[Any] = None, key: Optional[str] = None
    ):
    ...
    def listen_reactive_local(self, event_type: str) -> Computed[List[ControllerEvent]]:
    ...
    def once_local(self, event_type: str, callback: Callable):
    ...
    def once_global(self, event_type: str, callback: Callable):
    ...
    def off_local(self, event_type: str, callback: Callable = None):
    ...
    def off_global(self, event_type: str, callback: Callable = None):
    ...
    def get_context_reactive(self, key: str, default: Any = None) -> Computed[Any]:
    ...
    def listen_context(self, callback: Callable[[], None]) -> Observer:
    ...
    def get_global_context(self, key: str, default: Any = None):
    ...
    def create_rx_dict(self, initial_value: Dict[str, T] = None) -> RxDict[T]:
    ...
    def create_computed(self, compute_fn: Callable[[], T]) -> Computed[T]:
